...
without exhibiting actual !!{derivation}s in natural deduction. We provide
some of these !!{derivation}s in this capter.
...
axioms of~$\Th{Q}$? To prove a negated claim like this, we'd need
...
above.)  We've shown that if $\Th{T} \Proves !R$ there would be
!!a{derivation} of~$\ORProv(\gn{!R})$.  Then, since $\Th{T} \Proves R \liff
